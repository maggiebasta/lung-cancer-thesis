...
from tensorflow.keras.layers import (
    ...
    TimeDistributed, MaxPooling2D, ConvLSTM2D, Conv2D
)
...
def unet3d_dense_rec():
    ...
    pool2 = TimeDistributed(MaxPooling2D((2, 2)))(conc22)
    ...
    # pool3 = MaxPooling3D(pool_size=(1, 2, 2))(conc32)
    pool3 = TimeDistributed(MaxPooling2D((2, 2)))(conc32)
    ...
    pool4 = TimeDistributed(MaxPooling2D((2, 2)))(conc42)

    conv51 = TimeDistributed(ConvLSTM2D(512, (3, 3), strides=(1, 1), activation='relu', padding='same'))(pool4)
    # conv51 = Conv3D(512, (3, 3, 3), activation='relu', padding='same')(pool4)
    conc51 = concatenate([pool4, conv51], axis=4)
    conv52 = TimeDistributed(ConvLSTM2D(512, (3, 3), strides=(1, 1), activation='relu', padding='same'))(conc51)
    # conv52 = Conv3D(512, (3, 3, 3), activation='relu', padding='same')(conc51)
    conc52 = concatenate([pool4, conv52], axis=4)

    up6 = concatenate([Conv3DTranspose(256, (2, 2, 2), strides=(1, 2, 2), padding='same')(conc52), conc42], axis=4)
    ...
    up7 = concatenate([Conv3DTranspose(128, (2, 2, 2), strides=(1, 2, 2), padding='same')(conc62), conv32], axis=4)
    ...
    up8 = concatenate([Conv3DTranspose(64, (2, 2, 2), strides=(1, 2, 2), padding='same')(conc72), conv22], axis=4)
